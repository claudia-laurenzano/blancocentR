...
#' @format ## `cols_dcfs`
#' An object of class `palettes_palette` with
#' `r length(cols_dcfs)` discrete colors.
#'  Use `names(cols_dcfs)` to return all color names.
"cols_dcfs"
...
#'  Use `names(cols_dcfs1)` to return all color names.
"cols_dcfs1"

#' @rdname blanco_palettes
#' @format ## `cols_dcfs1_nm`
#' An object of class `palettes_palette` with
#' `r length(cols_dcfs1_nm)` discrete colors.
#'  Use `names(cols_dcfs1_nm)` to return all color names.
"cols_dcfs1_nm"

#' @rdname blanco_palettes
#' @format ## `cols_dcfs2`
#' An object of class `palettes_palette` with
#' `r length(cols_dcfs2)` discrete colors.
#'  Use `names(cols_dcfs2)` to return all color names.
"cols_dcfs2"

#' @rdname blanco_palettes
#' @format ## `cols_dcfs2_nm`
#' An object of class `palettes_palette` with
#' `r length(cols_dcfs2_nm)` discrete colors.
#'  Use `names(cols_dcfs2_nm)` to return all color names.
"cols_dcfs2_nm"
...
#' @format ## `cols_de`
#' An object of class `palettes_palette` with
#' `r length(cols_de)` discrete colors.
#'  Use `names(cols_de)` to return all color names.
"cols_de"
...
#'  Use `names(cols_de1)` to return all color names.
"cols_de1"

#' @rdname blanco_palettes
#' @format ## `cols_de1_nm`
#' An object of class `palettes_palette` with
#' `r length(cols_de1_nm)` discrete colors.
#'  Use `names(cols_de1_nm)` to return all color names.
"cols_de1_nm"

#' @rdname blanco_palettes
#' @format ## `cols_de2`
#' An object of class `palettes_palette` with
#' `r length(cols_de2)` discrete colors.
#'  Use `names(cols_de2)` to return all color names.
"cols_de2"

#' @rdname blanco_palettes
#' @format ## `cols_de2_nm`
#' An object of class `palettes_palette` with
#' `r length(cols_de2_nm)` discrete colors.
#'  Use `names(cols_de2_nm)` to return all color names.
"cols_de2_nm"
...
#' @format ## `cols_ldh1`
#' An object of class `palettes_palette` with
#' `r length(cols_ldh1)` discrete colors.
#'  Use `names(cols_ldh1)` to return all color names.
"cols_ldh1"

#' @rdname blanco_palettes
#' @format ## `cols_ldh1_nm`
#' An object of class `palettes_palette` with
#' `r length(cols_ldh1_nm)` discrete colors.
#'  Use `names(cols_ldh1_nm)` to return all color names.
"cols_ldh1_nm"

#' @rdname blanco_palettes
#' @format ## `cols_ldh2`
#' An object of class `palettes_palette` with
#' `r length(cols_ldh2)` discrete colors.
#'  Use `names(cols_ldh2)` to return all color names.
"cols_ldh2"
