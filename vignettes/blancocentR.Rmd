...
> -   ggplot themes
>
>     -   `theme_bc()` got a major update, including new features released in ggplot2 4.0.0. and no longer relies on {sysfonts} and {showtext}
>
...
> -   new: gt theme
>
>     -   added `gt_theme_bc()` to style gt tables
>
> -   colors
>
...
```{r pll, fig.height=4.5, fig.width=6}
library(glue)
library(dplyr)
data(louisiana_long)
org_var <- "LDH"
